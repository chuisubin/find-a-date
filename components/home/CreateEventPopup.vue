        ...
        <div class="lg:hidden flex flex-col gap-2">
          <DatePicker
            ...
            :disabled-date="
              (date) =>
                ...
                (mobileEndDate ? date > mobileEndDate : false)
            "
            class="w-full"
            input-class="input w-full "
            required
          ...
          <DatePicker
            ...
            :disabled-date="
              (date) =>
                disableBeforeToday(date) ||
                (mobileStartDate ? date < mobileStartDate : false)
            "
            class="w-full"
            input-class="input w-full "
            required
      ...
      <div class="mb-4">
        ...
        <DatePicker
          ...
          :disabled-date="
            (date) =>
              disableBeforeToday(date) ||
              (enableDateRange.length === 2 && date > enableDateRange[1])
          "
